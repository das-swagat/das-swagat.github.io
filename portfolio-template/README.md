...
The template code is licensed under the MIT License. No registration, application, payment, or approval is required. Keep the included `LICENSE` file with copies or substantial portions of the template. You may add your own copyright line for original modifications while retaining the existing notice.
